...
exports.handlerQuery = {
    //ROL
    viewRoles: 'SELECT * FROM rol ORDER BY codigo_ID',
    viewRolesDesc: 'SELECT descripcion FROM rol WHERE codigo_ID=$1 ORDER BY codigo_ID',
    //TIPO-IDENTIFICACION
    viewTipoIdentificaciones: 'SELECT * FROM tipo_identificacion ORDER BY codigo_ID',
    //USER    
    ...
    viewRolsUser: 'SELECT codigo_ID, descripcion FROM rol ORDER BY codigo_ID'
};
