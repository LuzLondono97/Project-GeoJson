...
class OrganizationRoute {
    ...
    configuracion() {
        ...
        //Para mostrar la organizacion cuando se este creando un usuario
        this.router.get('/viewOrganizationsUser', Organizations_Service_1.default.viewNameOrganizationsUsers);
    }
}
