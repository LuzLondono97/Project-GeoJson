...
class OrganizationService {
    ...
    // metodo para mostrar la organizacion en usuarios
    viewNameOrganizationsUsers(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let organizations = yield basedatos_1.default.query(Handle_Queries_1.handlerQuery['viewOrganizationsUser']);
                return Promise.resolve(Handle_Message_1.default(response, 200, organizations.rows));
            }
            catch (error) {
                Promise.reject(Handle_Message_1.default(response, 404, 'Error'));
